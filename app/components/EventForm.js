...
const labelCls = 'block text-xs font-semibold text-zinc-700 mb-1.5 uppercase tracking-wide'
const inputCls = 'w-full px-3 py-2 text-sm text-zinc-900 border border-zinc-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-zinc-400'
        ...
        <form onSubmit={handleSubmit} className="px-5 pt-4 pb-5 space-y-4">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <div className="flex gap-2">
              <button type="button" onClick={onClose}
                className="px-3 py-1.5 text-xs font-semibold text-zinc-700 hover:bg-zinc-100 rounded-lg">
                Cancel
              </button>
              <button type="submit"
            ...
            <div className="border-t border-zinc-200 pt-4 space-y-2">
              ...
              {shareStatus === 'sent' ? (
                <div className="flex items-center gap-2 bg-green-50 border border-green-200 rounded-lg px-3 py-2">
                  ...
                  <span className="text-xs font-semibold text-green-700">Added to approval queue</span>
                </div>
              ) : (
                <div className="flex gap-2">
                  <select
                    ...
                    className="flex-1 px-2.5 py-1.5 text-sm text-zinc-900 border border-zinc-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
                  >
                    {otherCals.map(c => (
